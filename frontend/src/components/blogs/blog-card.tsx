    ...
    return (
        <div className="bg-white dark:bg-slate-800 rounded-xl shadow-md border border-gray-200 dark:border-slate-700 transition-shadow hover:shadow-lg">
            ...
            <div className="p-4 flex flex-col gap-2">
                <div>
                    <div className="flex items-center justify-between mb-2">
                        ...
                        <div className="flex items-center gap-2">
                            <CustomImage className="h-5 w-5 rounded-full" src={site?.logo || ""} alt={site?.name} />
                ...
                <div>
                    <h3 className="font-bold text-gray-900 dark:text-white leading-tight mb-1">{post.title}</h3>
                    <p className="text-xs text-gray-600 dark:text-gray-400 mb-4 line-clamp-2">{post.excerpt}</p>
